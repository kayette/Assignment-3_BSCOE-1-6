...
def finalTotal(getAppleAmountF):
    if getAppleAmountF > 1:
        return print(f"\nYou can buy {getAppleAmountF} apples and your change is {changeTotal:,.2f} pesos.\n")
    elif getAppleAmountF == 1:
        return print(f"\nYou can buy {getAppleAmountF} apples and your change is {changeTotal:,.2f} pesos.\n")
    else:
        return print(f"\nYou cannot buy any apples. You need {need:,.2f} more pesos to complete a purchase.\n")
